-- call next value for hibernate_sequence; -- id 값을 증가시킴
...
-- call next value for hibernate_sequence; -- id 값을 증가시킴
insert into user (`id`, `name`, `email`, `created_at`, `updated_at`) values (5, 'martin', 'martin@slowcampus.com', now(), now());

insert into publisher(`id`, `name`) values (1, '패스트캠퍼스');

insert into book(`id`, `name`, `publisher_id`, `deleted`) values (1, 'JPA 초격차패키지', 1, false);

insert into book(`id`, `name`, `publisher_id`, `deleted`) values (2, 'Spring Security 초격차 패키지', 1, false);

insert into book(`id`, `name`, `publisher_id`, `deleted`) values (3, 'Spring Security 초격차 패키지', 1, true);   -- delete
